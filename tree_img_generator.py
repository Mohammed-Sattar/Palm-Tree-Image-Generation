...
for epoch in range(epochs):
    ...
    if epoch % 100 == 0:
        ...
        save_image(fake_imgs.view(-1, 3, img_size, img_size), f"generated_images/epoch_{epoch}.png", normalize=True)



def generate_images(age, num_images, save_dir="generated_data"):
